...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
	$ctable_where .= " (
							bus_stop_title like '%".$_REQUEST['searchName']."%'
						) AND ";
}
...
$get_total_rows = $db->rp_getTotalRecord($ctable1,$ctable_where); //hold total records in variable
...
$ctable_r = $db->rp_getData($ctable1,"*",$ctable_where,"id DESC limit $page_position, $item_per_page");
?>
       ...
       <thead>
        ...
        ?>
            <tr>
                ...
                <td><span class="<?php echo ($ctable_d['isActive']==0)?"text-danger":"text-success"; ?>"><?php echo stripslashes($ctable_d['bus_stop_title']); ?></span></td>
				<td><?php echo stripslashes($ctable_d['bus_stop_address']); ?></td>
				<td><?php echo stripslashes($ctable_d['bus_stop_locality']); ?></td>
