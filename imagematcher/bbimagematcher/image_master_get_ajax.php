       ...
       <thead>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $db->rp_getValue("department","name","id='".$ctable_d['department_id']."'"); ?></td>
				...
				<td><?php echo stripslashes($ctable_d['mobile']); ?></td>
				<td><?php echo date('d-m-Y',strtotime($ctable_d['birth_date'])); ?></td>
				<td><?php echo stripslashes($ctable_d['blood_group']); ?></td>
				<td><?php echo stripslashes($ctable_d['address']); ?></td>
				<?php
				$img=USER_MAIN.$ctable_d['image_path'];
				?>
