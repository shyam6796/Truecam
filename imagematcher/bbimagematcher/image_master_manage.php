...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo SITETITLE; ?> | Manage Image</title>
			   ...
			   <!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Manage Image
                            <small>Manage Image</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
							    	...
							    	<div class="portlet-body pull-right">
										...
										<form class="form-inline" role="form">
											<div class="form-group">
												...
												<input class="form-control" id="searchName" placeholder="Enter Name" type="text"> </div>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a id="add_bus" href="image_master_crud.php?mode=a" class="btn green"> Add New
...
function del_conf(id){
	var r = confirm("Are you sure you want to delete iamge Detail?");
	if(r){
