...
<title><?php echo SITENAME; ?> | Order Placed Successfully</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style=" padding-bottom: 0px;" valign="top"><img src="<?php echo SITEURL; ?>assets/images/logo.png" style="width: 132px; height: 37px; margin-left:-20px;" height="37" width="132" align="none"> </td>
																</tr>
															</tbody>
														</table></td>
												</tr>
							...
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
								<tr>
									<td valign="top" class="bodyContainer">
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong>Dear, <?php echo stripslashes($cart_detail_d['name']); ?></strong></td>
																</tr>
															</tbody>
														</table></td>
												</tr>
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top">
																		your order is placed.<br>
																		Your order ID: <?php echo $cart_id; ?> and Invoice ID: <?php echo $invoice_id; ?> | Order Placed on: <?php echo date_format(date_create($cart_detail_d['orderdate']),"d-m-Y"); ?><br>
																		<span style="font-size:Default Size"><span style="font-family:arial,sans-serif; line-height:107%">We will send you another email once the items in your order have been shipped. </span></span>
																		&nbsp; </td>
																</tr>
															</tbody>
														</table></td>
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"> Thank you for your order. your amount is paid by you.<br>
																		Your CCAvenue Payment Getaway order tracking ID : <?php echo $_REQUEST['tracking_id']; ?><br>
																		Your Bank Reference ID : <?php echo $_REQUEST['bank_ref_no']; ?>
																		&nbsp; </td>
																</tr>
															</tbody>
														</table></td>
										...
										<?php } ?>
										<div id="header" style="margin: 20px 0;padding: 8px 0;border: 0;font: bold 15px Helvetica, Sans-Serif;overflow: hidden;resize: none;height: 15px;width: 100%;background: #222;text-align: center;color: white;text-decoration: uppercase;letter-spacing: 20px">INVOICE</div>
										<div id="identity" style="margin: 0;padding: 0">
											<div id="address" style="margin: 0;padding: 0;border: 0;font: 14px Georgia, Serif;overflow: hidden;resize: none;width: 250px;height: 150px;float: left"> 
												Delivery Address :-<br>
												<?php
												...
												?>
												<br>
												Email: <?php echo stripslashes($cart_detail_d['email']); ?>
												<br>
												Phone: <?php echo stripslashes($cart_detail_d['phone']); ?>
											</div>
											<div id="logo" style="margin: 0;padding: 0;text-align: right;float: right;position: relative;margin-top: 25px;border: 1px solid #fff;max-width: 540px;max-height: 100px;overflow: hidden">
												<div id="logohelp" style="margin: 0;padding: 10px 5px;text-align: left;font-style: italic">
													<img id="image" src="<?php echo SITEURL; ?>assets/images/logo.png" alt="logo" style="margin: 0;padding: 0"/>
												</div>
											</div>
											<div style="clear: both;margin: 0;padding: 0">
												<div id="customer" style="margin: 0;padding: 0;overflow: hidden">
													<table id="meta" style="margin: 0;padding: 0;border-collapse: collapse;margin-top: 1px;width: 300px;float: right">
														<tr style="margin: 0;padding: 0">
															...
															<td style="margin: 0;padding: 5px;border: 1px solid black;text-align: right">
																<div style="margin: 0;padding: 0;border: 0;font: 14px Georgia, Serif;overflow: hidden;resize: none;width: 100%;height: 20px;text-align: right"><?php echo $invoice_id; ?></div>
															</td>
														</tr>
														<tr style="margin: 0;padding: 0">
															<td class="meta-head" style="margin: 0;padding: 5px;border: 1px solid black;text-align: left;background: #eee">Date</td>
															<td style="margin: 0;padding: 5px;border: 1px solid black;text-align: right">
																<div id="date" style="margin: 0;padding: 0;border: 0;font: 14px Georgia, Serif;overflow: hidden;resize: none;width: 100%;height: 20px;text-align: right"><?php echo date_format(date_create($cart_detail_d['orderdate']),'Y-m-d H:i:s'); ?></div>
															</td>
														</tr>
														<tr style="margin: 0;padding: 0">
															<td class="meta-head" style="margin: 0;padding: 5px;border: 1px solid black;text-align: left;background: #eee">
															<?php 
															if($cart_detail_d['payment_method']==2){
																echo "Amount Paid";
															}else{ 
																echo "Amount Due";
															}
															...
															<td style="margin: 0;padding: 5px;border: 1px solid black;text-align: right">
																<div class="due" style="margin: 0;padding: 0"><?php echo CURR.$db->rp_num($cart_detail_d['finaltotal']); ?></div>
															</td>
														</tr>
													</table>
												</div>
												<table id="items" style="margin: 30px 0 0 0;padding: 0;border-collapse: collapse;clear: both;width: 100%;border: 1px solid black">
													<tr style="margin: 0;padding: 0">
														<th style="margin: 0;padding: 5px;border: 1px solid black;background: #eee">Product Name</th>
														<th style="margin: 0;padding: 5px;border: 1px solid black;background: #eee">Delivery</th>
										...
										while($shop_cart_d = mysql_fetch_array($shop_cart_r)){
											...
											$sub_total 	+= $totalprice;
												...
												<tr class="item-row" style="margin: 0;padding: 0">
															<td class="item-name" style="margin: 0;padding: 5px;border: 0;vertical-align: top;width: 500px;border-right: 1px solid black;">
																<div class="delete-wpr" style="margin: 0;padding: 0;position: relative"> <?php echo $pro_name; ?></div>
															</td>
															<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;border-right: 1px solid black;">
															<?php echo $ship_days.' to '.intval($ship_days+2).' Days';?>
															</td>
															<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;">
										...
										$final_total = $db->rp_num(($sub_total + $shipping_charge + $tax) - $discount - $shipping_discount);
											...
											<tr id="hiderow" style="margin: 0;padding: 0;">
													...
													<tr style="margin: 0;padding: 0">
														...
														<td class="total-line" style="margin: 0;padding: 5px;border: 1px solid black;border-right: 1px solid black;text-align: right">Subtotal</td>
														<td class="total-value" style="margin: 0;padding: 10px;border: 1px solid black;border-left: 0;text-align: right;">
															<div id="subtotal" style="margin: 0;padding: 0"><?php echo CURR.$sub_total; ?> </div>
														</td>
													</tr>
											<?php
											if($discount>0){		
												...
												<tr style="margin: 0;padding: 0">
													<td class="blank" style="margin: 0;padding: 5px;border: 0"/>
													<td class="total-line" style="margin: 0;padding: 5px;border: 1px solid black;border-right: 1px solid black;text-align: right">Coupon Discount</td>
													<td class="total-value" style="margin: 0;padding: 10px;border: 1px solid black;border-left: 0;text-align: right;">
														<div id="subtotal" style="margin: 0;padding: 0">-<?php echo CURR.$db->rp_num($discount);?></div>
													</td>
												</tr>
											<?php
											}	
											...
											<tr style="margin: 0;padding: 0">
												<td class="blank" style="margin: 0;padding: 5px;border: 0"/>
												<td class="total-line" style="margin: 0;padding: 5px;border: 1px solid black;border-right: 1px solid black;text-align: right">Shipping Charge</td>
												<td class="total-value" style="margin: 0;padding: 10px;border: 1px solid black;border-left: 0;text-align: right;">
													<div id="subtotal" style="margin: 0;padding: 0"><?php echo CURR.$shipping_charge;?></div>
												</td>
											</tr>
											<?php
											...
											if($cart_detail_d['payment_method']==1){ 
												...
												<tr style="margin: 0;padding: 0">
														...
														<td class="total-value" style="margin: 0;padding: 10px;border: 1px solid black;border-left: 0;text-align: right;">
															<div id="subtotal" style="margin: 0;padding: 0"><?php echo CURR.$cod_charge;?></div>
														</td>
													</tr>
											<?php	
											}
											...
											<tr style="margin: 0;padding: 0">
														...
														<td class="total-value" style="margin: 0;padding: 10px;border: 1px solid black;border-left: 0;text-align: right;">
															<div id="total" style="margin: 0;padding: 0"><?php echo CURR.$final_total;?></div>
														</td>
													</tr>
												</table>
											</div>
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px;  padding-bottom: 9px;" valign="top"><strong>Note: Post shipment, the delivery of your item(s) will take anywhere between 2 to 7 working days depending on the location being served.</strong><br>
																		&nbsp;
																		<div style="text-align: center;">For any query, feel free to&nbsp;<a href="<?php echo SITEURL; ?>contact-us/" target="_blank">Contact Us</a></div></td>
																</tr>
															</tbody>
														</table></td>
												</tr>
								...
								<tr>
																															...
																															<tbody>
																																<tr>
																																	<td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left"><table width="" align="left" border="0" cellpadding="0" cellspacing="0">
																																			<tbody>
																																				<tr>
																																					<td class="mcnFollowIconContent" valign="middle" width="24" align="center"><a href="mailto:care@mufat.in" target="_blank"><img src="<?php echo SITEURL; ?>images/color-forwardtofriend-48.png" style="display:block;" class="" height="24" width="24"></a> </td>
																																				</tr>
																																			</tbody>
																																		</table></td>
																																</tr>
                                    ...
                                    <![endif]-->
										...
										<table class="mcnDividerBlock" style="min-width:100%;" width="100%" border="0" cellpadding="0" cellspacing="0">
											<tbody class="mcnDividerBlockOuter">
												<tr>
													<td class="mcnDividerBlockInner" style="min-width: 100%; padding: 9px 0px 0px 9px;"><table class="mcnDividerContent" style="min-width: 100%;border-top: 2px solid #0461C5;" width="100%" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td><span></span> </td>
																</tr>
