...
<title><?php echo SITENAME; ?> | Order Delivered</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
															...
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		<div style="text-align:justify;padding-top:5px;">We are pleased to inform that the following items in your order <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a> have been delivered. This completes your order. Thank you for shopping!</div>
																		<div style="text-align:justify;padding-top:5px;">Invoice details for this order are attached with this email for any future reference.</div>
																		<div style="text-align:justify;padding-top:5px;">Now process returns and complaints with a single click! Visit <a href="<?php echo SITEURL; ?>my-orders/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a></div>
																	</td>
																</tr>
															</tbody>
														</table></td>
										...
										while($shop_cart_d = mysql_fetch_array($shop_cart_r)){
											...
											if($orderitemstatus==0 || $orderitemstatus==5){
												...
												<tr class="item-row" style="margin: 0;padding: 0">
															<td class="item-name" style="margin: 0;padding: 5px;border: 0;vertical-align: top;width: 500px;border-right: 1px solid black;" colspan="2">
