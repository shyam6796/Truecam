											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top"><img src="<?php echo SITEURL; ?>assets/images/logo.png" style="width: 132px; height: 37px; margin: 0px;" height="37" width="132" align="none"> </td>
																</tr>
															</tbody>
														</table></td>
												</tr>
...
-->
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($_REQUEST['name']); ?>,</span></strong><br>
																		Thank you for shopping. we hope you satisfied with our products. we want your feedback for your purchased products. </td>
																</tr>
															</tbody>
														</table></td>
												</tr>
					...
					<tr>
						<td align="center" valign="top" id="templateFooter"><!--[if gte mso 9]>
							...
							<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
								<tr>
									<td valign="top" class="footerContainer"><table class="mcnButtonBlock" style="min-width:100%;" width="100%" border="0" cellpadding="0" cellspacing="0">
											<tbody class="mcnButtonBlockOuter">
												<tr>
													<td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center"><table class="mcnButtonContentContainer" style="border-collapse: separate ! important;border-radius: 3px;background-color: #0461C5;" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td style="font-family: Arial; font-size: 16px; padding: 15px;" class="mcnButtonContent" valign="middle" align="center"><a class="mcnButton " title="Give your Feedback here" href="https://docs.google.com/forms/d/1cSE_G1m0Y9eugw4Z7DUlUIFehu3gqJEDI_GUgD7JC5w/viewform" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Give Your Feedback Here</a> </td>
																</tr>
															</tbody>
														</table></td>
												</tr>
										...
										<table class="mcnFollowBlock" style="min-width:100%;" width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;" valign="top"><div style="text-align: center;"><br>
																			Copyright &copy; <?php echo date("Y"); ?> Mufat - All rights Reserved<br>
																			&nbsp;</div></td>
																</tr>
															</tbody>
														</table></td>
