...
<title><?php echo SITENAME; ?> | Order Return Request</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
															...
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		...
																		We  have received your return request for your order number <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a> and item name <strong>'<?php echo $db->rp_getValue("cartitems","name","id='".$_REQUEST['ciid']."'"); ?>'</strong>.
																		</div>
																	</td>
																</tr>
															</tbody>
											...
											if($orderitemstatus==0 || $orderitemstatus==5){
												...
												<tr class="item-row" style="margin: 0;padding: 0;">
															<td class="item-name" style="margin: 0;padding: 5px;border: 0;vertical-align: top;width: 500px;border-right: 1px solid black;">
																<div class="delete-wpr" style="margin: 0;padding: 0;position: relative;<?php if($orderitemstatus==5 || $orderitemstatus==0){?> text-decoration:line-through; <?php } ?>"> <?php echo $pro_name; ?> 
																</div>
																<div class="delete-wpr" style="margin: 0;padding: 0;position: relative;">
																<?php 
																if($orderitemstatus==5){
																	?><strong style="color:#FF0000;">( returned )</strong><?php
															...
															<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;border-right: 1px solid black;<?php if($orderitemstatus==5 || $orderitemstatus==0){?> text-decoration:line-through; <?php } ?>">
															<?php echo $ship_days.' to '.intval($ship_days+2).' Days';?>
															</td>
															<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;<?php if($orderitemstatus==5 || $orderitemstatus==0){?> text-decoration:line-through; <?php } ?>">
