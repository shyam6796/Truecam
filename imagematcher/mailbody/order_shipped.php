...
<title><?php echo SITENAME; ?> | Order Shipped</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top">
														<table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		<div style="text-align:justify">We are pleased to inform you that following items in your Order <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a> have been shipped.</div>
																		<div style="text-align:justify">You will receive your shipment within 2-7 working days after shipped.</div>
																	</td>
																</tr>
															</tbody>
														</table>
														<?php if($cart_detail_d["track_url"]!=""){ ?>
														<table class="mcnButtonBlock" style="min-width:100%;" width="100%" border="0" cellpadding="0" cellspacing="0">
															<tbody class="mcnButtonBlockOuter">
																<tr>
																	<td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center"><table class="mcnButtonContentContainer" style="border-collapse: separate ! important;border-radius: 3px;background-color: #0461C5;" border="0" cellpadding="0" cellspacing="0">
																			<tbody>
																				<tr>
																					<td style="font-family: Arial; font-size: 16px; padding: 15px;" class="mcnButtonContent" valign="middle" align="center"><a class="mcnButton " title="Track your Order" href="<?php echo $cart_detail_d["track_url"]; ?>" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Track your Order</a> </td>
																				</tr>
																			</tbody>
																		</table></td>
																</tr>
															...
															<tbody class="mcnTextBlockOuter">
																<tr>
																	<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
																			<tbody>
																				<tr>
																					<td class="mcnTextContent" style="padding: 9px 18px;color: #919191;" valign="top"><div style="text-align: center;"><span style="font-size:12px">Tracking ID may take up to 24 hours to get activated.</span></div></td>
																				</tr>
																			</tbody>
																		</table></td>
																</tr>
											...
											if($orderitemstatus==0 || $orderitemstatus==5){
												...
												<tr class="item-row" style="margin: 0;padding: 0">
													<td class="item-name" style="margin: 0;padding: 5px;border: 0;vertical-align: top;width: 500px;border-right: 1px solid black;">
														<div class="delete-wpr" style="margin: 0;padding: 0;position: relative;<?php if($orderitemstatus==0){?> text-decoration:line-through; <?php } ?>"> <?php echo $pro_name; ?> 
																</div>
														<div class="delete-wpr" style="margin: 0;padding: 0;position: relative;">
																<?php 
																if($orderitemstatus==0){
																	?><strong style="color:#FF0000;">( cancelled )</strong><?php
																}	
																?>
																</div>
													</td>
													<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;border-right: 1px solid black;<?php if($orderitemstatus==0){?> text-decoration:line-through; <?php } ?>">
													<?php echo $ship_days.' to '.intval($ship_days+2).' Days';?>
													</td>
													<td style="margin: 0;padding: 5px;border: 0;vertical-align: top;text-align: right;width: 150px;<?php if($orderitemstatus==0){?> text-decoration:line-through; <?php } ?>">
											...
											<tbody class="mcnTextBlockOuter">
												<tr>
													<td class="mcnTextBlockInner" valign="top"><table style="min-width:100%;" class="mcnTextContentContainer" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><div style="text-align: justify;">You can always visit your <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">order page</a> to view your order status and to contact us regarding this order.</div></td>
																</tr>
															</tbody>
														</table></td>
												</tr>
