...
<title><?php echo SITENAME; ?> | Order Item Return Request Rejected</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
															...
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		<div style="text-align:justify;padding-top:5px;">we receive your return request for your order number <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a> and item name <strong>'<?php echo $db->rp_getValue("cartitems","name","id='".$_REQUEST['ciid']."'"); ?>'</strong>. We are sorry to say that we can not accept this request due to some reason.</div>
																	</td>
																</tr>
															</tbody>
														</table></td>
