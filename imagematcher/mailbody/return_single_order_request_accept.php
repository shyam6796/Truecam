...
<title><?php echo SITENAME; ?> | Order Item Return Request Accepted</title>
<style type="text/css">
p {
	margin:10px 0;
	padding:0;
								...
								<tr>
															...
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		<div style="text-align:justify;padding-top:5px;">We have accepted return request for your order <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a> and item name <strong>'<?php echo $db->rp_getValue("cartitems","name","id='".$_REQUEST['ciid']."'"); ?>'</strong>.</div>
									...
									if(mysql_num_rows($shop_cart_r)>0){
										...
										while($shop_cart_d = mysql_fetch_array($shop_cart_r)){
											...
											if($orderitemstatus==5 || $orderitemstatus==0){
