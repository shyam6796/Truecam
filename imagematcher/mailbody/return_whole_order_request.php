															...
															<tbody>
																<tr>
																	<td class="mcnTextContent" style="padding-top:9px; padding-bottom: 9px;" valign="top"><strong><span style="font-family:calibri,sans-serif; font-size:14.0pt; line-height:107%">Dear <?php echo stripslashes($cart_detail_d['name']); ?>,</span></strong>
																		<div style="text-align:justify;padding-top:5px;">We  have received your return request for your order number <a href="<?php echo SITEURL; ?>order/<?php echo $cart_id; ?>/" style="color:#2baadf;font-weight:normal;text-decoration:underline" target="_blank">#<?php echo $cart_id; ?></a></div>
																	</td>
																</tr>
															</tbody>
														</table></td>
													...
													<table id="meta" style="margin: 0;padding: 0;border-collapse: collapse;margin-top: 1px;width: 300px;float: right">
														<tr style="margin: 0;padding: 0">
															...
															<td style="margin: 0;padding: 5px;border: 1px solid black;text-align: right">
																<div style="margin: 0;padding: 0;border: 0;font: 14px Georgia, Serif;overflow: hidden;resize: none;width: 100%;height: 20px;text-align: right"><?php echo $cart_id; ?></div>
															</td>
														</tr>
														<tr style="margin: 0;padding: 0">
