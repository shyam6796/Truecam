                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light portlet-fit bordered">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-hover table-bordered user_table_class" id="user_table_id">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
<th>Name</th>
...
<script src="js/user_datatable.js" type="text/javascript"></script>
<!-- END PAGELEVEL JS -->
    </body>
</html>	