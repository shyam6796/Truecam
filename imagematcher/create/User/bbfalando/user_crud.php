...
$params['country']=trim($db->clean($_REQUEST['country']));
	...
	if($mode=='a')
	{
		...
		$reply=$user_obj->insert($params,array("key"=>"email","value"=>$params['email']));
		if($reply['ack']==1)
		{
			   ...
			   <!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
						<!-- FORM START -->
						<form method="POST" role="form" id="form_user" name="form_user" class="[[:FORM_CLASS:]]" action="">
                            <div class="col-md-6 ">
                                ...
                                <div class="portlet light bordered">
									...
									<input class="form-control " value="<?php echo $name; ?>" name="name" id="name" type="text"  data-validation="required,length"   data-validation-length="min10" data-validation-error-msg="Enter atleast 10 Characters."  >
									<label for="name">Name</label>
									<span class="help-block"></span>
								</div><div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control "  value="<?php echo $email; ?>" name="email" id="email" type="email"  data-validation="required,email"    data-validation-error-msg="Enter Valid Email."  >
									<label for="email">Email</label>
									<span class="help-block"></span>
								</div><div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control " value="<?php echo $phone; ?>" name="phone" id="phone" type="text"  data-validation="required,length"   data-validation-length="min10" data-validation-error-msg="Enter atleast 10 Digits"  >
									...
									<span class="help-block"></span>
										...
										<input class="form-control form-filter input-sm date-picker" readonly="" id="bdate" name="bdate"  value="<?php echo $bdate; ?>"   placeholder="From" type="text">
										...
										<textarea name="address" class="form-control " id="address" rows="3"   ><?php echo $address; ?></textarea>
										<label for="address">Address</label>
										<span class="help-block"></span>
									</div><div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control " value="<?php echo $city; ?>" name="city" id="city" type="text"   >
									<label for="city">City</label>
									<span class="help-block"></span>
								</div><div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control " value="<?php echo $state; ?>" name="state" id="state" type="text"   >
									<label for="state">State</label>
									<span class="help-block"></span>
								</div><div class="form-group form-md-line-input form-md-floating-label has-info">
										<select class="form-control edited "  value="<?php echo $country; ?>"  id="country" name="country"  >
											<option value=""></option>
