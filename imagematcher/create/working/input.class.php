...
public $input_html_node=array("text"=>'<div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control [[:CLASS:]]" name="[[:NAME:]]" id="[[:ID:]]" type="text"  [[:VALIDATION:]] >
									<label for="[[:ID:]]">[[:LABEL:]]</label>
									<span class="help-block">[[:HELP_BLOCK:]]</span>
								</div>',
						"email"=>'<div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control [[:CLASS:]]" name="[[:NAME:]]" id="[[:ID:]]" type="email"  [[:VALIDATION:]] >
									<label for="[[:ID:]]">[[:LABEL:]]</label>
									<span class="help-block">[[:HELP_BLOCK:]]</span>
								</div>',
						"number"=>'<div class="form-group form-md-line-input form-md-floating-label">
									<input class="form-control [[:CLASS:]]" name="[[:NAME:]]" id="[[:ID:]]" type="number"  [[:VALIDATION:]] >
									<label for="[[:ID:]]">[[:LABEL:]]</label>
									<span class="help-block">[[:HELP_BLOCK:]]</span>
								</div>',
						"textarea"=>'<div class="form-group form-md-line-input form-md-floating-label">
										<textarea name="[[:NAME:]]" class="form-control [[:CLASS:]]" id="[[:ID:]]" rows="3"  [[:VALIDATION:]] ></textarea>
										<label for="[[:ID:]]">[[:LABEL:]]</label>
										<span class="help-block">[[:HELP_BLOCK:]]</span>
									</div>',
						"spinner"=>'<div class="form-group form-md-line-input form-md-floating-label has-info">
										<select class="form-control edited [[:CLASS:]]" id="[[:ID:]]" [[:VALIDATION:]] >
											<option value=""></option>
						...
						"datepicker"=>'<div class="form-group form-md-line-input form-md-floating-label has-info">
										...
										<input class="form-control form-filter input-sm" readonly="" id="[[:ID:]]" name="[[:NAME:]]"  placeholder="From" type="text">
...
public $required_JS=array("text"=>'',"email"=>'',"number"=>'',"textarea"=>'',"spinner"=>'',
						  ...
						  <script src="../assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript">',
						  "timepicker"=>'
						  <script src="../assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript">
						  <script src="../assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript">',
						  "datetimepicker"=>'
...
function createInput($input_type,$id,$name,$class,$label,$help_block,$validation="")
{
...
public function getRequireAssets($inputs)
{
	...
	if($intersection==$inputs)
	{
		...
		$required_css=implode("<br/>",array_unique($required_css));
		$required_js=implode("<br/>",array_unique($required_js));
